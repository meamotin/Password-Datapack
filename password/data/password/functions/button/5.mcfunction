...
execute as @e[type=text_display,tag=PS_KeyPad,tag=Text,sort=nearest,limit=1] if score @s password matches 1 run scoreboard players set @s password_1 5
...
execute as @e[type=text_display,tag=PS_KeyPad,tag=Text,sort=nearest,limit=1] if score @s password matches 2 run scoreboard players set @s password_2 5
...
execute as @e[type=text_display,tag=PS_KeyPad,tag=Text,sort=nearest,limit=1] if score @s password matches 3 run scoreboard players set @s password_3 5
...
execute as @e[type=text_display,tag=PS_KeyPad,tag=Text,sort=nearest,limit=1] if score @s password matches 4 run scoreboard players set @s password_4 5
...
## 剥奪
  advancement revoke @s only password:button/5